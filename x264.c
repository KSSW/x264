...
#define H2 if( longhelp == 2 ) printf
    ...
    H2( "      --tc                    Enable clock timestamp flag\n");
    H2( "      --tco                   Time code output\n");
...
static struct option long_options[] =
{
    ...
    { "TCO", required_argument, NULL, OPT_TCO },
    { "TC", no_argument, NULL, OPT_TC },
    ...
    for( optind = 0;; )
    {
        ...
        switch( c )
        {
            ...
            case OPT_TIMEBASE:
                ...
                break;
            case OPT_TC:
                param->b_timecode = 1; // Set flag to enable timecode
                break;
            case OPT_TCO:
                // Store the timecode argument
                param->timecode_str = optarg; // Assuming you add a field `char* timecode_str` to `x264_param_t`
                break;
            case OPT_PULLDOWN:
